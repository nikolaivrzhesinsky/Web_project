...
import com.example.bookmarketrest.service.serviceInerface.BookService;
...
public class BookController {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<BookResponseDto> getBook(@PathVariable final int id) {
    ...
    public ResponseEntity<BookResponseDto> deleteBook(@PathVariable final int id) {
    ...
    public ResponseEntity<BookResponseDto> addCategory(@PathVariable final int categoryId,
    ...
    public ResponseEntity<BookResponseDto> removeCategory(@PathVariable final int categoryId,
                                                          @PathVariable final int bookId) {
    ...
    public ResponseEntity<BookResponseDto> addAuthor(@PathVariable final int authorId,
                                                     @PathVariable final int bookId) {
    ...
    public ResponseEntity<BookResponseDto> removeAuthor(@PathVariable final int authorId,
                                                        @PathVariable final int bookId) {
