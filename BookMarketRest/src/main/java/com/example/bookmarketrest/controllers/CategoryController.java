...
public class CategoryController {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<CategoryResponseDto> getCategory(@PathVariable final int id) {
    ...
    public ResponseEntity<CategoryResponseDto> deleteCategory(@PathVariable final int id) {
